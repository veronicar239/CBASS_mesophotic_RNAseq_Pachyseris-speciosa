...
Archived files
> /RC/group/rc_barshis_lab/taxonarchive/Pachyseris_speciosa/
...
Gene models (CDS) file.

```
gzip -d pspe_0.12.maker_post_002.transcripts.fasta.gz
```

## Check assembly details
```
/cm/shared/courses/dbarshis/18AdvBioinf/scripts/avg_cov_len_fasta_advbioinf.py pspe_0.12.maker_post_002.transcripts.fasta
```

```
The total number of sequences is 39160
The average sequence length is 1847
The total number of bases is 72350345
The minimum sequence length is 123
The maximum sequence length is 40985
The N50 is 2608
Median Length = 763
contigs < 150bp = 2
contigs >= 500bp = 34913
contigs >= 1000bp = 25242
contigs >= 2000bp = 13037
...
```
nano addsuffixtofastaseqnames_b.sh
```
...
/cm/shared/courses/dbarshis/barshislab/VRad/taxons/Porites_astreoides/Paytan/P_ast/refassembly/P_ast_Kenkel/addsuffixtofastaseqnames.py Pspeciosa_Bongaerts /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/genome_Bongaerts/pspe_0.12.maker_post_002.transcripts.fasta
```

```
sbatch addsuffixtofastaseqnames_b.sh
```

output:
> /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/genome_Bongaerts/pspe_0.12.maker_post_002.transcripts_suffixed.fasta

Rename fasta file based on # of contigs
```
mv pspe_0.12.maker_post_002.transcripts_suffixed.fasta 39160_pspe_0.12.maker_post_002.transcripts_suffixed.fasta
```
...
Host
> /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/genome_Bongaerts/39160_pspe_0.12.maker_post_002.transcripts_suffixed.fasta
...
```
cat /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/genome_Bongaerts/39160_pspe_0.12.maker_post_002.transcripts_suffixed.fasta /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Siderastrea_siderea/refassembly/39006_Cladocopium_goreaui.Chen_suffixed.fasta > Pspe-CDS_Cgoreaui_hybridref.fasta
```

## Check assembly details

```
/cm/shared/courses/dbarshis/18AdvBioinf/scripts/avg_cov_len_fasta_advbioinf.py Pspe-CDS_Cgoreaui_hybridref.fasta
```

```
The total number of sequences is 78166
The average sequence length is 1736
The total number of bases is 135769635
The minimum sequence length is 111
The maximum sequence length is 40985
The N50 is 2511
Median Length = 720
contigs < 150bp = 7
contigs >= 500bp = 66616
contigs >= 1000bp = 46557
contigs >= 2000bp = 22661
```
...
#SBATCH -o 2023-02-02_Pspe_genomeGenerate.txt
#SBATCH -n 4
#SBATCH -N 1
#SBATCH --mail-user=vradice@odu.edu
#SBATCH --mail-type=ALL
...
STAR --runMode genomeGenerate --runThreadN 4 --genomeDir ./ --genomeFastaFiles /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --genomeChrBinNbits 16
```
...
*Requires gzip format if using '--readFilesCommand zcat' flag. Otherwise leave unzipped and remove flag*
```
nano gzip_Pspe_2.sh
```
...
#SBATCH -o 2023-02-02_PspeSTARMapping.txt
#SBATCH -n 16
#SBATCH -N 1
#SBATCH --mail-user=vradice@odu.edu
#SBATCH --mail-type=ALL
...
Output:  multiqc_report_CDS_Pspe_Cgoreaui.html

##### Move *Aligned.out.bam files into new directory.

```
mkdir aligned_hybridref_CDS
mv *Aligned.out.bam aligned_hybridref_CDS/
```

> /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/aligned_hybridref_CDS/
...
#SBATCH -o 2023-02-03_STAR-dedup_salmon-quant.txt
#SBATCH -n 16
#SBATCH -N 1
#SBATCH --mail-user=vradice@odu.edu
#SBATCH --mail-type=ALL
...
STAR --runThreadN 32 --runMode inputAlignmentsFromBAM --bamRemoveDuplicatesType UniqueIdenticalNotMulti --inputBAMfile 20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned.out.bam --outFileNamePrefix 20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bam

crun.salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant
...
cat 2023-02-03_STAR-dedup_salmon-quant.txt

The following have been reloaded with a version change:
  1) slurm/20.11.5 => slurm/21.08
Feb 03 16:57:41 ..... reading from BAM, remove duplicates, output BAM
Feb 03 16:59:48 ..... done
/etc/container_runtime/runtime: line 7: exec: quant: not found
Feb 03 16:59:50 ..... reading from BAM, remove duplicates, output BAM
Feb 03 17:02:31 ..... done
/etc/container_runtime/runtime: line 7: exec: quant: not found
Feb 03 17:02:32 ..... reading from BAM, remove duplicates, output BAM
Feb 03 17:04:29 ..... done

*Looks like you need to run "salmon quant..." instead of "crun.salmon quant..."*
...
and
/etc/container_runtime/runtime: line 7: exec: quant: not found (when used "crun.salmon quant...")

Found that files got double suffix somehow:  xxxxx_.bamProcessed.out.bamProcessed.out.bam

```
nano salmon-quant.sh
```

```
#!/bin/bash -l

#SBATCH -o 2023-02-03_salmon-quant.txt
#SBATCH -n 16
#SBATCH -N 1
#SBATCH --mail-user=vradice@odu.edu
#SBATCH --mail-type=ALL
...
crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_C_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_H_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_L_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_L_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_M_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_M_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_T0_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_T0_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_10_TF_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_10_TF_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_C_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_H_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_L_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_L_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_M_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_M_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_T0_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_T0_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_1_TF_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_1_TF_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_H_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_L_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_L_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_M_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_M_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_T0_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_T0_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_3_TF_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_3_TF_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_C_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_H_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_L_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_L_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_M_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_M_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_T0_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_T0_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_6_TF_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_6_TF_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_C_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_C_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_H_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_L_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_L_T3_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_M_T2_Pspe_CgoreauiAligned_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_T0_Pspe_CgoreauiAligned.out_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_T0_Pspe_CgoreauiAligned_deduped_salmon_quant

crun salmon quant -t /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/Pspe-CDS_Cgoreaui_hybridref.fasta --libType A -a 20220228_Meso_Pspe_8_TF_Pspe_CgoreauiAligned.out_deduped.bamProcessed.out.bamProcessed.out.bam -o 20220228_Meso_Pspe_8_TF_Pspe_CgoreauiAligned_deduped_salmon_quant
```

```
sbatch salmon-quant.sh
```
...
# Prepare files to import to R for DESeq2

Import the salmon quant counts into DESeq2.
...
```
./20220228_Meso_Pspe_6_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_TF_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_T0_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_T0_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_TF_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_C_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_T0_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_M_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_T0_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_TF_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_T0_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_TF_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_1_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_M_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_10_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_C_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_H_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_3_TF_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_6_L_T3_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
./20220228_Meso_Pspe_8_L_T2_Pspe_CgoreauiAligned_deduped_salmon_quant/quant.sf
```

```
ls *_salmon_quant/quant.sf
```

Copy quant.sf files to local computer for R import
```
scp -r vradice@turing.hpc.odu.edu:/cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/aligned_hybridref_CDS/*_salmon_quant/ ./
```
...
```
cp /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/aligned_hybridref_CDS/*_Pspe_CgoreauiAligned.out.bam /RC/group/rc_barshis_lab/taxonarchive/Pachyseris_speciosa/bam/
```

> /RC/group/rc_barshis_lab/taxonarchive/Pachyseris_speciosa/bam/


- raw fastq files

```
cp /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/*Pspe*_R*.fq.gz /RC/group/rc_barshis_lab/taxonarchive/Pachyseris_speciosa/rawfastq/
```

> /RC/group/rc_barshis_lab/taxonarchive/Pachyseris_speciosa/rawfastq/

- final counts file

> /cm/shared/courses/dbarshis/barshislab/VRad/taxons/Pachyseris_speciosa/data_RNAseq/aligned_hybridref_CDS/

Each sample has its own directory *_Pspe_CgoreauiAligned_deduped_salmon_quant

Inside the directory, there is the quant.sf file.
